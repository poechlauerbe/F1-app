...
document.getElementById('blue-flag').addEventListener('click', () => {
  blueFlag++;
  document.getElementById('blue-flag').textContent =
    blueFlag % 2 ? 'Blue Flag ON' : 'Blue Flag OFF';
  document.getElementById('blue-flag').style.backgroundColor =
    blueFlag % 2 ? 'blue' : 'white';
  document.getElementById('blue-flag').style.color =
    blueFlag % 2 ? 'white' : 'black';
  document.getElementById('blue-flag').style.borderColor =
    blueFlag % 2 ? 'blue' : 'black';
